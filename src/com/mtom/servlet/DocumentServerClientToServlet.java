...
import documentservices.wms0.rbcfg.servicemessage.DocumentServerClient;
...
public class DocumentServerClientToServlet {
    final static ObjectFactory of = new ObjectFactory();
    static Logger log = Logger.getLogger(DocumentServerClient.class);

    public javax.xml.ws.Holder<DocumentServices> serviceCall(Map<String, String> staticValues, Map<String, String> metaFieldsMap) throws ServiceException {
